...
intuir o futuro;\footnote{Ou, nas palavras de Artemidoro: ``ficção
  ...
  desempenham um papel particularmente interessante em ``O chamado de
...
que chamamos \emph{Renascimento}, pois, platônicos como eram, aquelas
...
a Revolução Industrial por uma \emph{técnica} desumanizada;\footnote{Basta
  ...
  George Orwell, \emph{The Lathe of Heaven} (A curva do sonho), de Ursula Le Guin e
...
popular\emph{.} Essas publicações, nos \textsc{eua}, começaram no fim do século \textsc{xix}
