...
\medskip
\IfFileExists{img/HEDRA_METABIBLIOTECA_LOGOBRANCO.png}{%
  \vspace*{3mm}\noindent\includegraphics[width=.42\textwidth,keepaspectratio]{img/HEDRA_METABIBLIOTECA_LOGOBRANCO.png}\par
