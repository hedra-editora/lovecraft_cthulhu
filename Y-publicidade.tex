...
{%
  \IfFileExists{img/hedraedicoes.eps}{%
    \vspace*{0mm}\noindent\includegraphics[width=.42\textwidth,keepaspectratio]{img/hedraedicoes.eps}\par
...
\IfFileExists{img/paideia.eps}{%
  \vspace*{0mm}\noindent\includegraphics[width=.42\textwidth,keepaspectratio]{img/paideia.eps}\par
}{\large\textsc{paideia}}
...
\IfFileExists{img/metabiblioteca.eps}{%
  \vspace*{0mm}\noindent\includegraphics[width=.42\textwidth,keepaspectratio]{img/metabiblioteca.eps}\par
...
\IfFileExists{img/ayllon.eps}{%
  \vspace*{0mm}\noindent\includegraphics[width=.42\textwidth,keepaspectratio]{img/ayllon.eps}\par
}{\large\textsc{ayllon}}
...
%\IfFileExists{img/walterbenjamin.eps}{%
%  \vspace*{0mm}\noindent\includegraphics[width=.42\textwidth,keepaspectratio]{img/walterbenjamin.eps}\par
%}{\large\textsc{walter benjamin}}
...
%\setlength\parskip{4.2pt}
%\setlength\itemsep{-1.4mm}
%\item \textit{Diário parisiense e outros escritos}
%\item \textit{O contador de histórias e outros textos}
%\end{enumerate}

\IfFileExists{img/quehorassao.eps}{%
  \vspace*{0mm}\noindent\includegraphics[width=.42\textwidth,keepaspectratio]{img/quehorassao.eps}\par
...
\IfFileExists{img/mundoindigena.eps}{%
  \vspace*{0mm}\noindent\includegraphics[width=.42\textwidth,keepaspectratio]{img/mundoindigena.eps}\par
...
\IfFileExists{img/anarc.eps}{%
  \vspace*{0mm}\noindent\includegraphics[width=.42\textwidth,keepaspectratio]{img/anarc.eps}\par
}{\large\textsc{anarc}}
