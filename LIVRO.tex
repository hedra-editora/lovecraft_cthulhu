...
\usepackage{enumitem}			% para tipos diferentes de enumeração/formatação ver `edlab-extra.sty`
...
% Fontes
\IfFontExistsTF{Formular}
  {\newfontfamily\formular{Formular}}
  {\newfontfamily\formular{Helvetica Neue}}
\IfFontExistsTF{Formular Light}
  {\newfontfamily\formularlight{Formular Light}}
  {\newfontfamily\formularlight{Helvetica Neue Light}}
\IfFontExistsTF{FS Brabo Pro Regular}
  {\newfontfamily\brabo{FS Brabo Pro Regular}}
  {\newfontfamily\brabo{Source Serif 4}}
% Definição robusta de "Times New Roman" com vários fallbacks
\IfFontExistsTF{Times New Roman}{
  \newfontfamily\timesnewroman{"Times New Roman"}[Ligatures=TeX]
}{
  \IfFontExistsTF{TeX Gyre Termes}{
    \newfontfamily\timesnewroman{TeX Gyre Termes}[Ligatures=TeX]
  }{
    \IfFontExistsTF{Times}{
      \newfontfamily\timesnewroman{Times}[Ligatures=TeX]
    }{
      \IfFontExistsTF{Tinos}{
        \newfontfamily\timesnewroman{Tinos}[Ligatures=TeX]
      }{
        % Último recurso: usa a fonte romana padrão do documento, sem erro
        \let\timesnewroman\rmfamily
      }
    }
  }
}
